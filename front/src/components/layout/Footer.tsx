        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center">
              ...
              <span className="text-xl font-medium ml-1">Network</span>
            </Link>
            <p className="mt-4 text-sm text-gray-600 max-w-md">
              Connecting surplus food with those who need it most. Together, we're reducing waste and fighting hunger in our communities.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/faqs" className="text-base text-gray-500 hover:text-gray-900">FAQs</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/food-safety" className="text-base text-gray-500 hover:text-gray-900">Food Safety Guidelines</Link>
              </li>
            </ul>
          </div>
        </div>
